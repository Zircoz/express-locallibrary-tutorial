...
elemBegin.addEventListener('click', async () => {
  ...
  if (verificationJSON && verificationJSON.verified) {
      ...
      elemError.innerHTML = 'Oh no, something went wrong! Response:' + JSON.stringify(verificationJSON) + "verificationJSON.verified" + JSON.stringify(verificationJSON.verified);
    }
});
